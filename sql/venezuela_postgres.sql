-- ========================================
-- Datos geograficos de Venezuela (PostgreSQL)
-- Kizme V001 - Para Supabase
-- ========================================
...
CREATE TABLE IF NOT EXISTS parroquias (
  ...
  id_municipio INTEGER REFERENCES municipios(id_municipio) ON DELETE CASCADE,
...
SELECT setval('estados_id_estado_seq', (SELECT COALESCE(MAX(id_estado), 1) FROM estados));
SELECT setval('municipios_id_municipio_seq', (SELECT COALESCE(MAX(id_municipio), 1) FROM municipios));
SELECT setval('parroquias_id_parroquia_seq', (SELECT COALESCE(MAX(id_parroquia), 1) FROM parroquias));
